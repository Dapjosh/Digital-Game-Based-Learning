...
public class EquationMedium  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View editA1 = findViewById(R.id.variable_a_1);
        View editA2 = findViewById(R.id.variable_a_2);
        View editA3 = findViewById(R.id.variable_a_3);
        View editA4 = findViewById(R.id.variable_a_4);
        View editA5 = findViewById(R.id.variable_a_5);
        View editA6 = findViewById(R.id.variable_a_6);
        View editA7 = findViewById(R.id.variable_a_7);
        View editA8 = findViewById(R.id.variable_a_8);
        View editA9 = findViewById(R.id.variable_a_9);
        View editA10 = findViewById(R.id.variable_a_10);
        View editA11 = findViewById(R.id.variable_a_11);
        View editA12 = findViewById(R.id.variable_a_12);
...
//                ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        for (int i=2; i<=13; i++){
           TextView text= (TextView) findViewById(R.id.variable_a_1);
            text.setText("" +i);
        ...
        countDownTimer = new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(EquationMedium.this,GameOver.class);
        ...
        buttonHelp.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                AlertDialog alertDialog = new AlertDialog.Builder(EquationMedium.this).create();
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(EquationMedium.this, Game.class);
